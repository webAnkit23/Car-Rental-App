    ...
    <section className='choose_section'>
        <div className="choose_container">
            <div className="choose_inner_container">
                <img src='src\components\ChooseSection\images_Choose\choose_car_banner.png'></img>
                <div className="choose_text_area">
                    ...
                    <div className="right_text">
                          <div className="right_text_block">
                            <img src='src\components\ChooseSection\images_Choose\text_area1.png'></img>
                          ...
                          <div className="right_text_block">
                            <img src='src\components\ChooseSection\images_Choose\text dollar.png'></img>
                            <div className="right_text_container">
                          ...
                          <div className="right_text_block">
                            <img src='src\components\ChooseSection\images_Choose\text_money.png'></img>
                            <div className="right_text_container">
